...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#image05', { style: 'zoom-out', speed: 1250, intensity: 7, delay: 125, staggerOrder: '', replay: false });
		onvisible.add('#text45', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, staggerOrder: '', replay: false });
		onvisible.add('#text02', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, staggerOrder: '', replay: false });
		onvisible.add('#text01', { style: 'fade-right', speed: 1000, intensity: 5, delay: 250, staggerOrder: '', replay: false });
		onvisible.add('#text46', { style: 'fade-right', speed: 1000, intensity: 5, delay: 250, staggerOrder: '', replay: false });
		onvisible.add('#buttons01', { style: 'fade-right', speed: 1000, intensity: 5, delay: 375, replay: false });
		onvisible.add('#icons07', { style: 'fade-right', speed: 1000, intensity: 5, delay: 250, stagger: 125, replay: false });
